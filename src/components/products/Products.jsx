...
export const products = [
...

    {
        ...
        price: 9,
        description: "Descripción: No hay nada divertido en el archienemigo de Batman, el Guasón. Cuando no era más que un ladrón de poca monta, el Guasón cayó a un tanque de residuos químicos que tornaron su piel blanca, su pelo verde y sus labios rojos; ¡justo como un payaso! Sus crímenes siempre incluyen malvadas bromas y chistes que sólo resultan divertidos para el Guasón. ¡Puede que no parezca más que un payaso, pero este villano no trae más que malas noticias para Batman y Ciudad Gótica!",
        category: "dc",
        logo: '/assets/LogoDc.webp',
        stock: 3
    },
...

    {
        ...
        price: 4,
        description: "Descripción: Catwoman es el alias de Selina Kyle, una ladrona de guante blanco moralmente reformada, con una relación romántica de idas y venidas con Batman. Se muestra como una mujer tenaz, independiente, y muy conflictiva con su pasado.",
        category: "dc",
        logo: '/assets/LogoDc.webp',
        stock: 9
    },

    {
        ...
        price: 7,
        description: "Descripción: Nada es más rápido que Flash en su veloz deportivo Mighty Micros, especialmente cuando tiene su superbebida energética favorita. Pero cuando eres un sereno y experto supervillano como el Capitán Frío, no necesitas ser más rápido que el hombre más rápido del mundo para ganar. Sólo tienes que disparar a la carretera con tu pistola de hielo y dejar que el indefenso héroe resbale hasta detenerse. Máxima velocidad frente a máximo poder congelador: ¿quién cruzará antes la línea de meta?",
        category: "dc",
        logo: '/assets/LogoDc.webp',
        stock: 15
    },
...

    {
        ...
        price: 3,
        description: "Descripción: ¡Las hadas madrinas suelen aparecer justo cuando más las necesitas! La de cenicienta decidió ayudarla a hacer realidad su sueño y escapar de su malvada madrastra y sus perversas hermanastras.",
        category: "disney",
        logo: '/assets/LogoDisney.png',
        stock: 6
    },

    {
        ...
        price: 6,
        description: "Descripción: ¡Maui es el semidiós más asombroso de todo el Pacífico! Carismático y gracioso, puede adoptar la forma de diferentes animales con su anzuelo mágico. Mitad dios, mitad mortal y totalmente asombroso, finalmente se convierte en un mentor y un fiel amigo para Moana.",
        category: "disney",
        logo: '/assets/LogoDisney.png',
        stock: 13
    },

    {
        ...
        price: 6,
        description: "Descripción: El príncipe Azul, un apuesto miembro de la familia real que habita en el castillo de la colina, bailó con Cenicienta en el baile. Cuando ella se fue corriendo, dejando atrás su zapatilla, se propuso volver a encontrarla.",
        category: "disney",
        logo: '/assets/LogoDisney.png',
        stock: 11
    },
    ...
    },
    {
        ...
        price: 4,
        description: "Descripción: Sebastián ama la música y las preocupaciones, y siempre ha protegido a Ariel. Pasa mucho tiempo enfrentando la terquedad de Ariel, pero también tiene mucho amor para ella.",
        category: "disney",
        logo: '/assets/LogoDisney.png',
        stock: 5
    },
    {
        ...
        price: 9,
        description: "Descripción: Gracias a su poder mágico, Elsa puede crear cosas asombrosas hechas de hielo y nieve. ¡Lo que más le gusta es preparar un día perfecto para su hermana y sus amigas!.",
        category: "disney",
        logo: '/assets/LogoDisney.png',
        stock: 18
    },
